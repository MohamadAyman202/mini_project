        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div>
                    ...
                    <p class="mg-b-0">Sales monitoring dashboard Tawredate.</p>
                </div>
            </div>
        </div>
        <!-- /breadcrumb -->
        ...
        <div class="row row-sm">
            <div class="col-6">
                <div class="card overflow-hidden sales-card bg-primary-gradient">
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        <div class="">
                            <h6 class="mb-3 tx-12 text-white">TODAY Categories</h6>
                        </div>
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $category_count }}</h4>
            ...
            <div class="col-6">
                <div class="card overflow-hidden sales-card bg-danger-gradient">
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        <div class="">
                            <h6 class="mb-3 tx-12 text-white">TODAY Products</h6>
                        </div>
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
